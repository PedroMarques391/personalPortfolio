...
export default function NotFoundPage() {
  ...
  return (
    <main className="w-full h-screen min-h-screen max-h-screen  items-center justify-center flex bg-[#0e0e0e] ">
      <div className="relative w-full flex flex-col items-center justify-center min-h-[calc(100vh-150px)] overflow-hidden">
        <motion.div
        ...
        <div className="relative z-10 text-center px-6 flex flex-col items-center">
          ...
          <p className="mt-4 mb-10 max-w-md mx-auto text-gray-dark text-base leading-relaxed">
            It seems this page got lost in cyberspace. Don&lsquo;t worry,
            we&#39;ll get you back on track.
          </p>

          <button
            onClick={handleBackToHome}
            className="group relative inline-flex items-center gap-3 px-8 py-4 font-bold uppercase tracking-[0.2em] text-white border-2 border-orange-500 hover:bg-orange-500 hover:text-black hover:shadow-[0_0_30px_rgba(249,115,22,0.5)] transition-all duration-300 active:scale-95 text-[0.85rem]"
          >
            <BsArrowLeft size={20} />
            Back to home
          </button>
