        ...
        <>
            {loading ? (
                ...
                <main className="w-full min-h-screen bg-black relative">
                    ...
                    <button
                        className={`w-10 h-10 sm:h-12 sm:w-12 bg-white/30 justify-center items-center flex fixed bottom-10 right-5 md:right-10 rounded-xl duration-500 transition-opacity ${scrollY ? "opacity-1" : "opacity-0"
                            }`}
                    >
